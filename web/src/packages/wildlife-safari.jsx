...
export default function WildlifeSafariAdventure() {
  const places = [
    {
  ...
  return (
    <div className="min-h-screen bg-[#f6faf6]">
      ...
      <section className="relative h-[60vh] sm:h-[70vh]">
        <img
          src="/assets/packages-pic/wildlife.jpg"
        ...
        >
          ...
          <p className="max-w-2xl mx-auto sm:mx-0 text-base sm:text-lg text-white/90 mb-6">
            Get close to nature with thrilling safaris and unforgettable wildlife encounters.
          </p>
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight">
              About the{" "}
              <span className="text-[#4F6F52]">Safari Adventure</span>
            </h2>

            <div className="w-20 h-1 bg-[#4F6F52] rounded-full" />

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              Sri Lanka is one of the best destinations in Asia for wildlife safaris.
              Explore vast national parks, spot majestic elephants, elusive leopards,
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-4 sm:pt-6">
              {[
                ...
                { value: "2 Parks", label: "Safaris" },
                { value: "Elephants", label: "Highlights" },
                { value: "Leopards", label: "Rare Sightings" },
              ].map((stat, i) => (
                <div
                  key={i}
          ...
          >
            ...
            <ul className="space-y-4 sm:space-y-5">
              {[
                { icon: <FaPaw />, text: "High leopard density in Yala" },
                { icon: <FaLeaf />, text: "Large elephant herds in Udawalawe" },
                { icon: <FaBinoculars />, text: "Guided jeep safaris" },
                { icon: <FaMapMarkerAlt />, text: "Southern Sri Lanka parks" },
                { icon: <FaLandmark />, text: "Protected national reserves" },
              ].map((item, i) => (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {[
            {
              title: "Yala Safari",
              desc: "Search for leopards, sloth bears, and crocodiles.",
              icon: <FaPaw />,
              duration: "4 Hours",
            },
            {
              title: "Udawalawe Elephant Safari",
              desc: "Witness large elephant herds in open grasslands.",
              icon: <FaLeaf />,
              duration: "3 Hours",
            },
            {
              title: "Wildlife Photography",
              desc: "Capture stunning moments of Sri Lanka’s wildlife.",
              icon: <FaBinoculars />,
              duration: "Flexible",
            },
          ].map((item, index) => (
      ...
      <section className="max-w-7xl mx-auto px-6 py-0 sm:py-2">
        ...
        <div className="rounded-2xl overflow-hidden shadow">
          <iframe
            ...
            src="https://www.google.com/maps?q=Yala%20National%20Park%20Sri%20Lanka&output=embed"
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="space-y-4">
          {[
            {
              q: "Best time for safaris?",
              a: "February to July offers the best wildlife sightings.",
            },
            {
              q: "Are safaris safe?",
              a: "Yes. All safaris are conducted by experienced guides.",
            },
            {
              q: "Can children join?",
              a: "Yes, but we recommend ages 6+ for jeep safaris.",
            },
          ].map((faq, index) => (
            <motion.div
              key={index}
      ...
      <section className="bg-gradient-to-r from-[#4F6F52] to-[#5A7D5A] py-14 sm:py-16 px-4 sm:px-6 mb-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            Ready for a Wildlife Adventure?
          </h2>

          <p className="text-white/90 text-sm sm:text-base mb-6">
            Let us create your ultimate safari experience.
          </p>
