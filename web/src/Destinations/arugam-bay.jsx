...
export default function ArugamBay() {
  const highlights = [
    ...
    "Wildlife & lagoon safaris",
    "Stunning east coast sunsets",
  ];
  ...
  const experiencePoints = [
    {
      ...
      description: "One of Asia’s top surfing destinations with world-class waves",
      color: "bg-emerald-50",
      iconColor: "text-emerald-600"
    },
    {
      icon: <FaUmbrellaBeach />,
      title: "Chill Beach Life",
      description: "Long sandy beaches with a laid-back tropical atmosphere",
      color: "bg-amber-50",
    ...
    },
    {
      icon: <FaCamera />,
      title: "Scenic Views",
      description: "Sunrise beaches, dunes, and coastal viewpoints",
      color: "bg-blue-50",
    ...
    },
    {
      ...
      description: "Lagoon safaris, temples, and wildlife parks",
      color: "bg-purple-50",
  ...
  const quickFacts = [
    { icon: <FaMapMarkerAlt />, label: "Location", value: "Arugam Bay", detail: "East Coast" },
    { icon: <FaSun />, label: "Best Time", value: "May – Oct", detail: "Surf season" },
    { icon: <FaClock />, label: "Visit Duration", value: "2–4 Days", detail: "Beach stay" },
    { icon: <FaWater />, label: "Famous For", value: "Surfing", detail: "World-class waves" },
    { icon: <FaTicketAlt />, label: "Ideal For", value: "Surf & Chill", detail: "Beach lovers" },
    { icon: <FaLandmark />, label: "Vibe", value: "Laid-back", detail: "Relaxed & social" },
  ];

  const faqs = [
    {
      question: "Why is Arugam Bay famous?",
      answer: "Arugam Bay is famous for its world-class surf breaks and relaxed beach town atmosphere.",
    },
    {
      question: "When is the surfing season in Arugam Bay?",
      answer: "The best surfing season runs from May to October.",
    },
    {
      question: "Is Arugam Bay suitable for beginners?",
      answer: "Yes. There are surf breaks suitable for beginners as well as advanced surfers.",
    },
    {
      question: "Are there other activities besides surfing?",
      answer: "Yes. Lagoon safaris, yoga, beach relaxation, and nearby wildlife parks are popular.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] flex">
        <div
          ...
          style={{
            backgroundImage: "url('/assets/destinations-pics/arugambay.jpg')",
          }}
        >
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-40">
          <div className="max-w-xl">
            ...
            >
              Ride world-class waves and embrace the laid-back lifestyle on Sri
              Lanka’s legendary east coast surf haven.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Sri Lanka’s Surf Capital</p>
                </div>
              </div>

              <p className="text-gray-700 leading-relaxed mb-6 text-base sm:text-lg">
                Arugam Bay is a world-renowned surf destination attracting
                surfers and travelers from across the globe. Its relaxed vibe,
                golden beaches, and nearby nature spots make it a unique coastal
                escape.
              </p>
            ...
            <div className="sticky top-8">
              <div className="bg-gradient-to-br from-[#4F6F52] to-[#3b5540] rounded-2xl shadow-xl p-6 text-white">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold mb-2">Surf Season</h4>
                    <p className="text-sm">May to October</p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">Nearby Spots</h4>
                    <p className="text-sm">Lagoon Safari, Kumana National Park</p>
                  </div>

                  <div>
                    <h4 className="font-semibold mb-2">Ideal For</h4>
                    <p className="text-sm">Surfers, backpackers, beach lovers</p>
                  </div>
                </div>
