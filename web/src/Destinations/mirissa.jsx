...
export default function Mirissa() {
  const highlights = [
    "Golden crescent-shaped beach",
    "Whale & dolphin watching",
    "Palm-tree viewpoints",
  ...
  const experiencePoints = [
    {
      ...
      description: "One of the best places in Sri Lanka to see blue whales",
      color: "bg-amber-50",
    ...
    },
    {
      ...
      description: "Calm turquoise waters and soft golden sand",
      color: "bg-emerald-50",
    ...
    },
    {
      ...
      description: "Iconic palm-lined viewpoint overlooking the ocean",
      color: "bg-blue-50",
    ...
    },
    {
      icon: <FaSun />,
      title: "Sunset Vibes",
      description: "Stunning sunsets with cafés and beach bars",
      color: "bg-purple-50",
  ...
  const quickFacts = [
    { icon: <FaMapMarkerAlt />, label: "Location", value: "Mirissa", detail: "Southern Coast" },
    { icon: <FaSun />, label: "Best Time", value: "Nov – Apr", detail: "Calm seas" },
    { icon: <FaClock />, label: "Visit Duration", value: "1–2 Days", detail: "Beach stay" },
    { icon: <FaWater />, label: "Famous For", value: "Whales", detail: "Marine life" },
    { icon: <FaTicketAlt />, label: "Ideal For", value: "Beach & Relax", detail: "Coastal escape" },
    { icon: <FaLandmark />, label: "Vibe", value: "Lively", detail: "Chill & social" },
  ];

  const faqs = [
    {
      question: "What is Mirissa famous for?",
      answer: "Mirissa is famous for whale watching, beautiful beaches, and its vibrant beach nightlife.",
    },
    {
      question: "When is whale watching season in Mirissa?",
      answer: "The best time for whale watching is from November to April.",
    },
    {
      question: "Is Mirissa good for swimming?",
      answer: "Yes. Mirissa Beach is generally safe for swimming, especially during the dry season.",
    },
    {
      question: "Is Mirissa suitable for couples?",
      answer: "Absolutely. Mirissa is popular for romantic beach stays and sunset experiences.",
    },
  ];
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] flex">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-40">
          <div className="max-w-xl">
            ...
            >
              Discover Sri Lanka’s laid-back beach paradise, where whales,
              sunsets, and tropical vibes create unforgettable memories.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Sri Lanka’s Southern Beach Escape</p>
                </div>
              </div>

              <p className="text-gray-700 leading-relaxed mb-6 text-base sm:text-lg">
                Mirissa is a lively coastal town known for its relaxed beach
                atmosphere, whale watching tours, and scenic viewpoints. It’s a
                favorite stop for travelers looking to unwind by the ocean.
              </p>
              ...
              <div className="bg-gradient-to-br from-[#4F6F52] to-[#3b5540] rounded-2xl shadow-xl p-6 text-white">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm">
                      Whale watching, swimming, sunset viewing
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Coconut Tree Hill, Secret Beach
                    </p>
                  </div>
