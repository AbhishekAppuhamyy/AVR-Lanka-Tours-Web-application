...
export default function Destinations() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* HERO SECTION */}
      <section className="relative min-h-[75vh] lg:min-h-[80vh] flex items-center justify-center">
        <div
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center text-white">
          <motion.div
            ...
            className="space-y-8"
          >
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold leading-tight drop-shadow-lg mt-6">
              Discover{" "}
